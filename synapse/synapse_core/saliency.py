"""
Saliency Normalizer — Z3 Reference: §4 of 01_main_definition.md

Causal saliency normalizer S_t : [0,∞)^t → ℝ.
Computes running z-scores and applies gated softplus to ensure non-negativity.
"""
